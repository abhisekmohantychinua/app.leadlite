import{d as ce}from"./chunk-BZM4RP73.js";import{A as v,Aa as se,B as b,Ba as ae,C as P,Da as le,Ga as g,L as G,T as J,W as ee,_ as te,d as q,da as D,e as K,f as $,ha as ie,i as U,ia as oe,j as m,sa as ne,wa as re,x as X,xa as y,y as I}from"./chunk-TICBVB54.js";import{Ac as f,Bc as W,Cb as M,Gb as u,Hb as r,Ib as j,Jb as N,Kb as T,Ma as z,Mb as S,Na as _,Nb as x,S as V,T as H,Vb as L,X as p,Za as E,_a as A,aa as l,ac as Q,ba as c,bb as F,cc as Y,db as d,dc as O,fb as w,gb as R,ma as C,nb as Z,sb as h,tb as k,ub as B}from"./chunk-AVM5YMMJ.js";var de=["content"],he=["*"],ue=(i,s)=>({showTransitionParams:i,hideTransitionParams:s}),fe=(i,s)=>({value:i,params:s}),me=i=>({closeCallback:i});function ve(i,s){}function be(i,s){i&1&&d(0,ve,0,0,"ng-template")}function ye(i,s){if(i&1){let e=M();k(0,"div",1),u("click",function(o){l(e);let n=r();return c(n.onOverlayClick(o))})("@animation.start",function(o){l(e);let n=r();return c(n.onAnimationStart(o))})("@animation.done",function(o){l(e);let n=r();return c(n.onAnimationEnd(o))}),k(1,"div",2),u("click",function(o){l(e);let n=r();return c(n.onContentClick(o))})("mousedown",function(o){l(e);let n=r();return c(n.onContentClick(o))}),N(2),d(3,be,1,0,null,3),B()()}if(i&2){let e=r();L(e.cn(e.cx("root"),e.styleClass)),h("ngStyle",e.style)("@animation",O(14,fe,e.overlayVisible?"open":"close",O(11,ue,e.showTransitionOptions,e.hideTransitionOptions))),Z("aria-modal",e.overlayVisible)("aria-label",e.ariaLabel)("aria-labelledBy",e.ariaLabelledBy),_(),L(e.cx("content")),_(2),h("ngTemplateOutlet",e.contentTemplate||e._contentTemplate)("ngTemplateOutletContext",Y(17,me,e.onCloseClick.bind(e)))}}var ge=`
.p-popover {
